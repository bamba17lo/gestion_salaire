...
<h1 class="app-page-title">Departements</h1>
                ...
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                ...
		                <div class="section-intro">Ajouter ici un nouvel departmeent.</div><br><br>
  ...
  <circle cx="8" cy="4.5" r="1"/>
									    ...
									    <input type="text" class="form-control" name="name" id="name" placeholder="Nom du departement" value="">
										@error('name')
