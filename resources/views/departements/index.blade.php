...
@endif
      ...
      <path fill-rule="evenodd" d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
            ...
            <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
                <span class="flex-sm-fill text-sm-center nav-link active" id="orders-all-tab" data-bs-toggle="tab" href="" role="tab" aria-controls="orders-all" aria-selected="true">Tout les Departements</span>
                                ...
                                <table class="table app-table-hover mb-0 text-left">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="cell"><span class="truncate">{{$value->name}}</span></td>
                                            <td class="cell">
                                                <a class="btn-sm app-btn-secondary" href="{{route('departement.edit',$value->id)}}">Modifier</a>
                                                <a class="btn-sm app-btn-secondary" href="{{route('departement.delete',$value->id)}}">Supprimer</a>
