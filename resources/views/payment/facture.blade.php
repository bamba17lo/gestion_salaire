    ...
    <div class="box-container">
        ...
        <div class="transaction-box">
            ...
            <div class="item">
                ...
                <div class="value">{{$fullPaymentInfo->employe->id}} </div>
            </div>
            <div class="item">
                <div class="label">Nom & prénom:</div>
                <div class="value">{{$fullPaymentInfo->employe->prenom}} 
                    {{$fullPaymentInfo->employe->nom}} ({{$fullPaymentInfo->employe->email}})
                </div>
            </div>
            <div class="item">
                <div class="label">Département:</div>
                <div class="value">{{$fullPaymentInfo->employe->departement->name}}</div>
            </div>
            <div class="item">
